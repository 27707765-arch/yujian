...
// 混合上传：图片走imageFilter，视频走videoFilter（分开过滤）
const mixedUpload = uploadService.mixedUpload([
...
// 编辑动态
router.put('/:id', mixedUpload, contentAudit({ fields: ['content'] }), postController.updatePost);
