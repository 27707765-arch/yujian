...
CREATE TABLE IF NOT EXISTS messages (
    ...
    type TINYINT(1) DEFAULT 0 COMMENT '消息类型：0-文字，1-图片，2-语音，3-视频，4-贴纸，5-位置，6-礼物，99-系统',
    ...
    sticker_id INT UNSIGNED DEFAULT NULL COMMENT '贴纸ID',
    location_data JSON DEFAULT NULL COMMENT '位置数据',
    gift_data JSON DEFAULT NULL COMMENT '礼物数据',
    quoted_message_id INT UNSIGNED DEFAULT NULL COMMENT '引用消息ID',
    quoted_content VARCHAR(200) DEFAULT NULL COMMENT '引用消息内容',
